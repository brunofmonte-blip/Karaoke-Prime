...
const BadgeItem: React.FC<{ badge: Badge, isEarned: boolean }> = ({ badge, isEarned }) => {
  ...
  return (
    <div className={cn(
      "p-4 rounded-xl border-2 transition-all duration-300 flex flex-col items-center text-center h-full",
...
const AchievementsSection: React.FC = () => {
  ...
  return (
    <div className="py-8">
      ...
      {!isUserLoggedIn && (
        <div className="text-center p-6 bg-primary/10 border border-primary/50 rounded-xl max-w-xl mx-auto">
