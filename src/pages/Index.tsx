...
KARAOKE <span className="text-primary drop-shadow-[0_0_15px_rgba(34,211,238,0.5)]">PRIME</span>
</h1>
...
className="cursor-pointer group p-6 rounded-3xl border border-primary/50 bg-black/60 hover:bg-primary/20 transition-all h-56 shadow-2xl flex flex-col justify-between"
>
<div className="h-12 w-12 rounded-xl bg-primary/20 flex items-center justify-center text-primary">
<Music size={24} />
</div>
<div>
<h3 className="font-black text-white text-xl uppercase italic">Basic</h3>
<p className="text-[10px] text-gray-400 mt-2 font-bold uppercase">
Karaoke tradicional e batalhas e duetos online.
</p>
</div>
</Card>
<Card
...
<div>
<h3 className="font-black text-white text-xl uppercase italic">Academy</h3>
<p className="text-[10px] text-gray-400 mt-2 font-bold uppercase">
10 níveis com treinamento profissional.
</p>
</div>
</Card>
<Card
onClick={() => navigate("/Next Talent")}
className="cursor-pointer group p-6 rounded-3xl border border-primary/50 bg-black/60 hover:bg-primary/20 transition-all h-56 shadow-2xl flex flex-col justify-between"
>
<div className="h-12 w-12 rounded-xl bg-primary/20 flex items-center justify-center text-primary">
<Globe size={24} />
...
<div>
<h3 className="font-black text-white text-xl uppercase italic">Next Talent</h3>
<p className="text-[10px] text-gray-400 mt-2 font-bold uppercase">Audições gamificadas para amadores.</p>
</div>
</Card>
<Card
...
<div>
<h3 className="font-black text-white text-xl uppercase italic">Backstage</h3>
<p className="text-[10px] text-gray-400 mt-2 font-bold uppercase">
Audições gamificadas para profissionais.
</p>
</div>
</Card>
<Card
onClick={() => navigate("/Next Success")}
className="cursor-pointer group p-6 rounded-3xl border border-primary/50 bg-black/60 hover:bg-primary/20 transition-all h-56 shadow-2xl flex flex-col justify-between"
>
<div className="h-12 w-12 rounded-xl bg-primary/20 flex items-center justify-center text-primary">
<Sparkles size={24} />
...
<p className="text-[10px] text-gray-400 mt-2 font-bold uppercase">Transforme suas ideias em músicas IA.</p>
  ...
  <section className="relative z-20 max-w-5xl mx-auto w-full px-4 -mt-12 mb-32">
    <div className="flex bg-zinc-900/90 backdrop-blur border border-white/10 rounded-full p-2 items-center shadow-2xl">
      ...
      <Input
        ...
        className="border-0 bg-transparent text-white focus-visible:ring-0 h-16 text-lg w-full font-medium"
      />
      ...
      <Button className="rounded-full bg-primary hover:bg-white text-black font-black uppercase tracking-widest px-12 h-16 transition-colors">
        Buscar
      </Button>
    </div>
  </section>
  ...
  <section className="max-w-7xl mx-auto px-4 w-full mb-32">
    <h2 className="text-5xl font-black text-white text-center mb-16 italic tracking-tighter uppercase">
      Mural de <span className="text-primary drop-shadow-[0_0_10px_rgba(34,211,238,0.5)]">Conquistas</span>
    </h2>
    <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
      {[
        { icon: Star, t: "Early Bird", c: "text-primary" },
        { icon: Mic2, t: "Rock Star", c: "text-white" },
        { icon: Trophy, t: "Duel Master", c: "text-primary" },
        { icon: Medal, t: "Perfect Pitch", c: "text-white" },
        { icon: Globe, t: "Polyglot", c: "text-primary" },
      ].map((b, i) => (
        <Card
          key={i}
          className="bg-zinc-950 border-white/10 flex flex-col items-center p-8 text-center rounded-[2rem] hover:border-white/30 transition-all"
        >
          <div
            className={`h-20 w-20 rounded-full border-2 flex items-center justify-center mb-6 bg-black ${b.c} border-current shadow-[0_0_15px_rgba(34,211,238,0.1)]`}
          >
  ...
  <section className="max-w-7xl mx-auto px-4 w-full mb-32">
    <h2 className="text-3xl font-black text-white text-center mb-12 uppercase italic tracking-tighter flex items-center justify-center gap-4">
      <Globe className="text-primary" /> Músicas Mais Cantadas
    </h2>
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      {[
        ...
        <Card
          key={i}
          className="bg-zinc-950 border-white/10 p-8 rounded-[2rem] hover:border-primary transition-colors flex flex-col items-center"
        >
          <img
            src={`https://flagcdn.com/w160/${c.f}.png`}
            className="w-16 mb-4 rounded shadow-lg border border-white/10"
            alt={c.n}
          />
          ...
          <Button
            variant="outline"
            className="rounded-full text-[10px] font-black uppercase tracking-widest h-8 border-white/20 hover:bg-white hover:text-black transition-all"
          >
  ...
  <section className="max-w-7xl mx-auto px-4 w-full mb-32">
    <h2 className="text-3xl font-black text-white mb-8 italic uppercase tracking-tighter">
      Trend Topics <span className="text-primary">🔥</span>
    </h2>
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
      {[1, 2, 3, 4].map((i) => (
        <div
          key={i}
          className="relative aspect-[9/16] rounded-3xl overflow-hidden group cursor-pointer border border-white/10 bg-zinc-900 shadow-2xl"
        >
          <img
            src={`https://picsum.photos/seed/singer_prime_${i}/600/800`}
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-transparent p-6 flex flex-col justify-end">
            ...
            <div className="flex gap-4 mt-4 opacity-70">
              <div className="flex items-center gap-1">
                ...
                <span className="text-[8px] font-black">12k</span>
              </div>
              <div className="flex items-center gap-1">
                <MessageCircle size={14} className="text-white" />
                <span className="text-[8px] font-black">842</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <section className="max-w-7xl mx-auto px-4 w-full mb-32 grid grid-cols-1 lg:grid-cols-2 gap-16">
    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-4">
        {[
          { t: "Evidências", a: "Chitãozinho" },
          { t: "Tennessee", a: "Chris Stapleton" },
          { t: "Coração", a: "Revelação" },
          { t: "Electro", a: "DJ Zedd" },
        ].map((item, i) => (
          <Card
            key={i}
            className="bg-zinc-950 border-white/5 p-4 rounded-2xl flex items-center gap-4 hover:bg-white/5 transition-colors cursor-pointer"
          >
            <div className="h-16 w-16 bg-zinc-800 rounded-lg shrink-0 overflow-hidden border border-white/10">
              <img
                src={`https://picsum.photos/seed/karaoke_${i}/150/150`}
                alt="Cover"
            ...
            <div className="truncate">
              ...
              <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest">{item.a}</p>
            </div>
          </Card>
        ))}
      </div>
    ...
    {/* Trend Tags */}
    <div>
      <h2 className="text-3xl font-black text-white mb-8 italic uppercase tracking-tighter flex gap-3">
        Trend Tags <span className="bg-primary/20 text-primary px-2 rounded-md">#</span>
      </h2>
      <div className="space-y-3">
        {["Sertanejo2026", "RockClassics", "VocalAcademyChallenge", "AnimeHits"].map((tag, idx) => (
          <div
            key={tag}
            className="bg-zinc-950 border border-white/10 rounded-2xl p-5 flex justify-between items-center hover:border-primary cursor-pointer transition-all group"
          >
            <div className="flex items-center gap-4">
              <span className="text-primary font-black text-xl italic">#</span>
              <div>
                <p className="font-black text-white text-base italic uppercase">{tag}</p>
                <p className="text-[10px] text-gray-500 font-black uppercase">{10 + idx * 5}k Cantores</p>
              </div>
            </div>
            <span className="text-green-400 text-xs font-black bg-green-400/10 px-3 py-1 rounded-full">
              +{(idx + 1) * 12}% ↗
            </span>
          </div>
        ))}
  ...
  {/* 8. RANKINGS GLOBAIS */}
  <section className="max-w-7xl mx-auto px-4 w-full mb-32">
    <h2 className="text-5xl font-black text-primary text-center mb-16 uppercase italic tracking-tighter drop-shadow-[0_0_15px_rgba(34,211,238,0.4)]">
      Rankings Globais
    </h2>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {["Global Top 5", "Nacional Top 3", "Local Top 2"].map((title, idx) => (
        <Card
          key={title}
          className={`bg-zinc-950 p-8 rounded-[2.5rem] border-2 shadow-2xl ${
            idx === 0 ? "border-primary shadow-primary/5" : "border-white/10"
          }`}
        >
          <h3
            className={`text-xl font-black text-center mb-8 uppercase italic ${
              idx === 0 ? "text-primary" : "text-white"
            }`}
          >
            {title}
          </h3>
  ...
  <section className="max-w-7xl mx-auto px-4 w-full mb-32 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
    <div>
      <h2 className="text-4xl font-black text-primary mb-12 uppercase italic tracking-tighter drop-shadow-[0_0_10px_rgba(34,211,238,0.5)]">
        Evolução Vocal<br />
      ...
      <div className="text-center space-y-6 bg-zinc-950 border border-white/10 p-12 rounded-[2.5rem] shadow-2xl">
        ...
        <p className="text-gray-400 font-medium font-bold uppercase text-[10px] tracking-widest">
          {user ? "Seus dados estão sendo processados pela IA." : "Cante para gerar os gráficos!"}
        </p>
        <p className="text-primary font-black uppercase tracking-[0.3em] text-[10px] pt-6 flex items-center justify-center gap-2">
          <Sparkles size={14} /> IA PRONTA PARA ANALISAR
        </p>
      </div>
    </div>
      ...
      <div className="flex items-center gap-6 mb-10 pb-10 border-b border-white/10">
        {user?.photoURL ? (
          ...
          <div className="h-24 w-24 rounded-full border-2 border-primary/50 bg-primary/10 flex items-center justify-center shadow-lg">
            <LucideUser size={40} className="text-primary" />
          </div>
        )}
        <div>
          <h3 className="text-2xl font-black text-white mb-1 italic tracking-tighter uppercase">
            {user ? user.displayName : "Cantor Convidado"}
          </h3>
          <p
            className={`text-[10px] font-black tracking-widest uppercase inline-block px-3 py-1 rounded-md ${
              user ? "text-primary bg-primary/10" : "text-gray-500 bg-gray-500/10"
            }`}
          >
      ...
      <div className="space-y-4">
        <div className="flex justify-between py-2 border-b border-white/5">
          <span className="text-[10px] font-black uppercase text-gray-500 tracking-widest flex items-center gap-2">
            <Star size={12} className="text-primary" /> Melhor Nota
          </span>
          <span className="font-black text-white text-lg">{user ? "94.8%" : "0.0%"}</span>
        </div>
        <div className="flex justify-between py-2 border-b border-white/5">
          <span className="text-[10px] font-black uppercase text-gray-500 tracking-widest flex items-center gap-2">
            <GraduationCap size={12} className="text-primary" /> Nível Academy
          </span>
          <span className="font-black text-white text-lg">{user ? "Lvl 1" : "0"}</span>
        </div>
        <div className="flex justify-between py-2">
          <span className="text-[10px] font-black uppercase text-gray-500 tracking-widest flex items-center gap-2">
            <Trophy size={12} className="text-primary" /> Ranking Global
          </span>
          <span className="font-black text-white text-lg">{user ? "#412" : "9999"}</span>
        </div>
      </div>
    </Card>
  </section>
