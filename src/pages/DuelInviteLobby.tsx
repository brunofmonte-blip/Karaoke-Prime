...
const DuelInviteLobby = () => {
  ...
  const handleSearch = () => {
    ...
    // Simulando uma busca no banco de dados de usuários
    setTimeout(() => {
      setMockUsers([
  ...
  const handleInvite = (userName: string) => {
    ...
    // Simula o usuário aceitando após 3 segundos e indo para a Arena
    setTimeout(() => {
    ...
    <div className="min-h-screen bg-background p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Card da Música */}
          <Card className="glass-pillar border-white/10 rounded-3xl overflow-hidden h-fit">
          ...
          <Card className="glass-pillar border-primary/30 rounded-3xl overflow-hidden">
        ...
        {/* Botão de Pular direto para a IA */}
