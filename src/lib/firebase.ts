...
export const googleProvider = new GoogleAuthProvider();// 🚨 ATENÇÃO: ESTE CÓDIGO DEVE FICAR NO ARQUIVO src/pages/Login.tsx
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { Mic2, Loader2 } from 'lucide-react';
import { Button } from '@/components/ui/button';

// 💡 AQUI ESTÁ A CORREÇÃO: Apontando exatamente para a pasta lib!
